...
USE `image_board`;
DROP procedure IF EXISTS `image_board`.`new_ban`;
...
USE `image_board`;
DROP procedure IF EXISTS `image_board`.`get_ban`;
...
USE `image_board`;
DROP procedure IF EXISTS `image_board`.`get_recent_post_date`;
...
USE `image_board`;
DROP procedure IF EXISTS `image_board`.`get_user_posts`;
