...
-- -----------------------------------------------------
-- Table `image_board`.`posters`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `image_board`.`posters` ;

CREATE TABLE IF NOT EXISTS `image_board`.`posters` (
...
CREATE TABLE IF NOT EXISTS `image_board`.`posts` (
  ...
  CONSTRAINT `poster`
    FOREIGN KEY (`poster`)
    REFERENCES `image_board`.`posters` (`ip`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `image_board`.`images`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `image_board`.`images` ;

CREATE TABLE IF NOT EXISTS `image_board`.`images` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `image_board`.`bans`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `image_board`.`bans` ;

CREATE TABLE IF NOT EXISTS `image_board`.`bans` (
...
DELIMITER $$
USE `image_board`$$
CREATE PROCEDURE `new_thread` (board_id INT, new_title VARCHAR(100), new_comment TEXT, new_author VARCHAR(45), image_name VARCHAR(100))
BEGIN
	START TRANSACTION;
...
DELIMITER $$
USE `image_board`$$
CREATE PROCEDURE `new_reply` (new_comment TEXT, new_author VARCHAR(45), thread_id INT, image_name VARCHAR(100))
BEGIN
	START TRANSACTION;
...
USE `image_board`;
DROP procedure IF EXISTS `image_board`.`new_image`;
